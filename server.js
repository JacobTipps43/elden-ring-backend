...
app.get('/api/eldenringWeps/strengthWeps', (req, res) => {
    res.json(strengthWeapons);
});

app.get('/api/eldenringWeps/dexterityWeps', (req, res) => {
    res.json(dexterityWeapons);
});

app.get('/api/eldenringWeps/mageWeps', (req, res) => {
    res.json(mageWeapons);
});

app.get('/api/eldenringWeps/arcaneWeps', (req, res) => {
    res.json(arcaneWeapons);
});

app.get('/api/eldenringWeps/faithWeps', (req, res) => {
    res.json(faithWeapons);
});

app.get('/api/eldenringTalismans/strengthTalismans', (req, res) => {
    res.json(strengthTalismans);
});

app.get('/api/eldenringTalismans/dexterityTalismans', (req, res) => {
    res.json(dexterityTalismans);
});

app.get('/api/eldenringTalismans/mageTalismans', (req, res) => {
    res.json(mageTalismans);
});

app.get('/api/eldenringTalismans/arcaneTalismans', (req, res) => {
    res.json(arcaneTalismans);
});

app.get('/api/eldenringTalismans/faithTalismans', (req, res) => {
    res.json(faithTalismans);
});

app.get('/api/eldenringLocations/strengthLocations', (req, res) => {
    res.json(strengthLocations);
});

app.get('/api/eldenringLocations/dexterityLocations', (req, res) => {
    res.json(dexterityLocations);
});

app.get('/api/eldenringLocations/mageLocations', (req, res) => {
    res.json(mageLocations);
});

app.get('/api/eldenringLocations/arcaneLocations', (req, res) => {
    res.json(arcaneLocations);
});

app.get('/api/eldenringLocations/faithLocations', (req, res) => {
    res.json(faithLocations);
});

app.get('/api/eldenringWeps', (req, res) => {
    res.send(`<h1>Elden Ring Weapons</h1>
        <p>Strength Weapons: <a href="/api/eldenringWeps/strengthWeps">Here</a></p>
        <p>Dexterity Weapons: <a href="/api/eldenringWeps/dexterityWeps">Here</a></p>
        <p>Mage Weapons: <a href="/api/eldenringWeps/mageWeps">Here</a></p>
        <p>Arcane Weapons: <a href="/api/eldenringWeps/arcaneWeps">Here</a></p>
        <p>Faith Weapons: <a href="/api/eldenringWeps/faithWeps">Here</a></p>
    `);
});

app.get('/api/eldenringTalismans', (req, res) => {
    res.send(`<h1>Elden Ring Talismans</h1>
        <p>Strength Talismans: <a href="/api/eldenringTalismans/strengthTalismans">Here</a></p>
        <p>Dexterity Talismans: <a href="/api/eldenringTalismans/dexterityTalismans">Here</a></p>
        <p>Mage Talismans: <a href="/api/eldenringTalismans/mageTalismans">Here</a></p>
        <p>Arcane Talismans: <a href="/api/eldenringTalismans/arcaneTalismans">Here</a></p>
        <p>Faith Talismans: <a href="/api/eldenringTalismans/faithTalismans">Here</a></p>
    `);
});

app.get('/api/eldenringLocations', (req, res) => {
    res.send(`<h1>Elden Ring Locations</h1>
        <p>Strength Locations: <a href="/api/eldenringLocations/strengthLocations">Here</a></p>
        <p>Dexterity Locations: <a href="/api/eldenringLocations/dexterityLocations">Here</a></p>
        <p>Mage Locations: <a href="/api/eldenringLocations/mageLocations">Here</a></p>
        <p>Arcane Locations: <a href="/api/eldenringLocations/arcaneLocations">Here</a></p>
        <p>Faith Locations: <a href="/api/eldenringLocations/faithLocations">Here</a></p>
    `);
});
